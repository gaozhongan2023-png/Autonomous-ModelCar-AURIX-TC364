...
#define IPS114_SDA_IN_PIN       SPI1_MISO_P10_1   //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define IPS114_CS_PIN           SPI1_CS9_P10_5    //定义SPI_CS引脚
     
#define IPS114_BL_PIN           P11_11             //液晶背光引脚定义 由于实际通讯未使用P15_4因此 这里复用为GPIO
#define IPS114_REST_PIN         P11_10             //液晶复位引脚定义
#define IPS114_DC_PIN           P10_1             //液晶命令位引脚定义
